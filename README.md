...
- 最高准则：一切以眼见为实，杜绝速写，不得捏造、臆造；线图是照片与实测证据的转译，不是凭经验画出的器物想象图。
- 人形器物以及其他器物上的人物形象，不能按人物速写、卡通或图标处理；正面、侧面、背面和局部视图共用轴线、基准线和比例，先结构后细节，人物姿态、肢体、服饰、持物以及浮雕、线刻、彩绘均须逐段按原图还原。
- 锈蚀、包浆、污渍、反光和拍摄阴影不作为纹饰绘出；锈蚀下仍可辨认的纹饰必须保留，不可辨认处留空、断线或明确标注待复核，不得用常见纹样补齐。
- 陶器、瓷器的釉面边界、釉线、流釉和釉上/釉下可见纹饰须按证据表达；转折线、圈足、器壁厚度及真实剖面关系不得省略。
- 只要有可靠尺寸，就必须在对应视图中标注与图面一致的比例尺；没有可靠尺寸时不虚构比例尺。
- 最终独立成果必须同时提供真正的 SVG 矢量主稿和 PNG 预览；SVG 只用路径、线段、圆弧等几何元素表达，不嵌入原始位图。
